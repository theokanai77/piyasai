...
// Function to fetch bulletins data (public demo - no authentication)
async function fetchBulletins() {
  try {
    ...
    // Always return all data for public demo
...
async function DashboardContent() {
  ...
  return (
    <main className="min-h-screen">
      <Bulten channels={channels} videos={videos} />
    </main>
  );
}

// This is a public demo page: No authentication required
// It's a server component which means you can fetch data before the page is rendered.
