      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white py-8 px-6 shadow rounded-lg">
          ...
          <button
            ...
            className="w-full flex justify-center items-center px-4 py-3 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500"
          >
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-gray-500">
              ...
              ve{" "}
              <a href="/tos" className="text-orange-600 hover:text-orange-500">
                Kullanım Şartları
              </a>{" "}
